...
Public Class VMElenco
        ...
        Try
            ...
            If GroupA.Visible = True Then
                For Each Control In GroupA.Controls
                    If Control.Name.StartsWith("VmHD") OrElse Control.Name.StartsWith("VmHd") Then
                        Try
                            If My.Computer.Network.Ping(Control.Tag) = True Then
                                ...
                                Else
                                    ...
                                    Try
                                        Dim Path As String = "\\noemanas\CustomerService\GestioneHD\VM\" & Control.Tag & ".txt"
                                        Dim Str As String
    ...
    VmHD6.Click, VM7HD55.Click, VmHD17.Click, VM7HD35.Click, VmHD19.Click, VmHD24.Click, VM7HD31.Click, _
    VmHd35.Click, VmHd10.Click, VmHD11.Click, VmHd13.Click, VmHD18.Click, VmHD29.Click, VmHd39.Click, VM7HD08.Click, _
    VmHD14.Click, VmHD15.Click, VmHD20.Click, VM7HD21.Click, VmHD23.Click, VmHd26.Click, VmHd41.Click, VmHD30.Click, _
    VmHd34.Click, VM7HD32.Click, VM7HD33.Click, VM7HD36.Click, VM7HD40.Click, VM7HD27.Click, VM7HD30.Click, VM7HD45.Click, _
    VM7HD44.Click
        ...
        Select Case sender.name <> ""
            Case sender.name = "VM7HD35"
                Storage = "VmStd6"
            Case sender.name = "VmHD29"
                Storage = "VmStd6"
            Case sender.name = "VmHD18"
                Storage = "VmStd6"
